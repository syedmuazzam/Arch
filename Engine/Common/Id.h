...
namespace arch::id
{
	...
	// anonymous namespace (used to hide implementation details from the public interface)
	namespace internal
	{
	...
	constexpr u32 min_deleted_indices{ 1024 };
	...
	/// <summary> Returns the index part of the id. </summary>
	...
	/// <summary> Returns the generation part of the id. </summary>
	constexpr id_type generation(id_type id)
	{
		return id >> internal::index_bits & internal::generation_mask;
	}

	/// <summary> Creates a new id from the given index and generation. </summary>
